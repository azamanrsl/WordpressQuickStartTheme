...
if (!function_exists('ot_display_by_type')) {
    function ot_display_by_type($args = [])
    {
...
if (!function_exists('ot_type_background')) {
    function ot_type_background($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        $ot_recognized_background_fields = apply_filters('ot_recognized_background_fields', [
          'background-color',
          'background-repeat',
...
if (!function_exists('ot_type_category_checkbox')) {
    function ot_type_category_checkbox($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        /* get category array */
        $categories = get_categories(apply_filters('ot_type_category_checkbox_query', ['hide_empty' => false], $field_id));
...
if (!function_exists('ot_type_category_select')) {
    function ot_type_category_select($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        /* get category array */
        $categories = get_categories(apply_filters('ot_type_category_select_query', ['hide_empty' => false], $field_id));
...
if (!function_exists('ot_type_colorpicker')) {
    function ot_type_colorpicker($args = [])
    {
...
if (!function_exists('ot_type_custom_post_type_checkbox')) {
    function ot_type_custom_post_type_checkbox($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        $post_type = isset($field_post_type) ? explode(',', $field_post_type) : ['post'];

        /* query posts array */
        $my_posts = get_posts(apply_filters('ot_type_custom_post_type_checkbox_query', ['post_type' => $post_type, 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any'], $field_id));
...
if (!function_exists('ot_type_custom_post_type_select')) {
    function ot_type_custom_post_type_select($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        /* query posts array */
        $my_posts = get_posts(apply_filters('ot_type_custom_post_type_select_query', ['post_type' => $post_type, 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any'], $field_id));
...
if (!function_exists('ot_type_date_picker')) {
    function ot_type_date_picker($args = [])
    {
...
if (!function_exists('ot_type_date_time_picker')) {
    function ot_type_date_time_picker($args = [])
    {
    ...
    // Turns arguments array into variables
        ...
        if (isset($matches[1])) {
          ...
          // The string is only IDs
            $ids = !empty($field_value) && $field_value != '' ? explode(',', $field_value) : [];
        }
...
if (!function_exists('ot_type_list_item')) {
    function ot_type_list_item($args = [])
    {
...
if (!function_exists('ot_type_measurement')) {
    function ot_type_measurement($args = [])
    {
...
if (!function_exists('ot_type_numeric_slider')) {
    function ot_type_numeric_slider($args = [])
    {
...
if (!function_exists('ot_type_page_checkbox')) {
    function ot_type_page_checkbox($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        /* query pages array */
        $my_posts = get_posts(apply_filters('ot_type_page_checkbox_query', ['post_type' => ['page'], 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any'], $field_id));
...
if (!function_exists('ot_type_page_select')) {
    function ot_type_page_select($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        /* query pages array */
        $my_posts = get_posts(apply_filters('ot_type_page_select_query', ['post_type' => ['page'], 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any'], $field_id));
...
if (!function_exists('ot_type_post_checkbox')) {
    function ot_type_post_checkbox($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        /* query posts array */
        $my_posts = get_posts(apply_filters('ot_type_post_checkbox_query', ['post_type' => ['post'], 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any'], $field_id));
...
if (!function_exists('ot_type_post_select')) {
    function ot_type_post_select($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        /* query posts array */
        $my_posts = get_posts(apply_filters('ot_type_post_select_query', ['post_type' => ['post'], 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any'], $field_id));
...
if (!function_exists('ot_type_radio_image')) {
    function ot_type_radio_image($args = [])
    {
...
if (!function_exists('ot_type_sidebar_select')) {
    function ot_type_sidebar_select($args = [])
    {
...
if (!function_exists('ot_type_social_links')) {
    function ot_type_social_links($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        if (empty($field_value) && apply_filters('ot_type_social_links_load_defaults', true, $field_id)) {
            $field_value = apply_filters('ot_type_social_links_defaults', [
        [
...
if (!function_exists('ot_type_tag_checkbox')) {
    function ot_type_tag_checkbox($args = [])
    {
...
if (!function_exists('ot_type_tag_select')) {
    function ot_type_tag_select($args = [])
    {
...
if (!function_exists('ot_type_taxonomy_checkbox')) {
    function ot_type_taxonomy_checkbox($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        /* setup the taxonomy */
        $taxonomy = isset($field_taxonomy) ? explode(',', $field_taxonomy) : ['category'];

        /* get taxonomies */
        $taxonomies = get_categories(apply_filters('ot_type_taxonomy_checkbox_query', ['hide_empty' => false, 'taxonomy' => $taxonomy], $field_id));
...
if (!function_exists('ot_type_taxonomy_select')) {
    function ot_type_taxonomy_select($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        /* get taxonomies */
        $taxonomies = get_categories(apply_filters('ot_type_taxonomy_select_query', ['hide_empty' => false, 'taxonomy' => $taxonomy], $field_id));
...
if (!function_exists('ot_type_textarea')) {
    function ot_type_textarea($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        wp_editor(
          ...
          [
            ...
            'quicktags'     => apply_filters('ot_quicktags', ['buttons' => 'strong,em,link,block,del,ins,img,ul,ol,li,code,spell,close'], $field_id),
          ]
        );
...
if (!function_exists('ot_type_textarea_simple')) {
    function ot_type_textarea_simple($args = [])
    {
...
if (!function_exists('ot_type_textblock')) {
    function ot_type_textblock($args = [])
    {
...
if (!function_exists('ot_type_textblock_titled')) {
    function ot_type_textblock_titled($args = [])
    {
...
if (!function_exists('ot_type_typography')) {
    function ot_type_typography($args = [])
    {
    ...
    /* turns arguments array into variables */
        ...
        /* allow fields to be filtered */
        $ot_recognized_typography_fields = apply_filters('ot_recognized_typography_fields', [
          'font-color',
          'font-family',
          'font-size',
          'font-style',
