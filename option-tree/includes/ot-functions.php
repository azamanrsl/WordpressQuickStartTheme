...
if (!function_exists('ot_wpml_filter')) {
    ...
    // Return translated strings using WMPL
        if (function_exists('icl_t')) {
          ...
          // List Item & Slider
                    if ($option_id == $setting['id'] && in_array($setting['type'], ['list-item', 'slider'])) {
                        ...
                        // List Item & Slider
                    } elseif ($option_id == $setting['id'] && $setting['type'] == 'social-links') {
                        foreach ($options[$option_id] as $key => $value) {
                            foreach ($value as $ckey => $cvalue) {
                                $id = $option_id.'_'.$ckey.'_'.$key;
                                $_string = icl_t('Theme Options', $id, $cvalue);
                    ...
                    } elseif ($option_id == $setting['id'] && in_array($setting['type'], apply_filters('ot_wpml_option_types', ['text', 'textarea', 'textarea-simple']))) {
