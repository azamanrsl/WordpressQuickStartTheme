    ...
    class OT_Meta_Box
    {
        ...
        public function add_meta_boxes()
        {
            foreach ((array) $this->meta_box['pages'] as $page) {
                add_meta_box($this->meta_box['id'], $this->meta_box['title'], [$this, 'build_meta_box'], $page, $this->meta_box['context'], $this->meta_box['priority'], $this->meta_box['fields']);
            }
        }
         ...
         * @since     1.0
         */
        public function build_meta_box($post, $metabox)
        {
            ...
            /* required title setting */
              ...
              ot_list_item_settings($field['id']);
                ...
                /* verify sub setting has a type & value */
                        ...
                        $new = $_POST[$field['id']];
                    } elseif ($field['type'] == 'social-links') {
